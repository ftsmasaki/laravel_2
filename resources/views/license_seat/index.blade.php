  ...
  <div class="col-12">
    <div class="table-responsive mb-4">
      <table class="table text-center align-middle">
        ...
        <tr>
          <td>
            <a href="/license_seat/{{ $license_seat->id }}/edit" class="text-decoration-none">{{ $license_seat->id }}</a>
          </td>
          <td>{{ $license_seat->license->product->product_name }}</td>
          <td>{{ $license_seat->license->product_key }}</td>
          ...
          <td>
            <form action="/license_seat/{{ $license_seat->id }}" method="post">
    ...
    <div class="mb-4 text-end pe-2"><a href="/license_seat/create" class="btn btn-primary">新規作成</a></div>
    <div class="mb-4 d-flex justify-content-center">{{ $license_seats->appends(request()->query())->links() }}</div>
  </div>
</div>
@endsection